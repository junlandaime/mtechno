...
<head>
  ...
  <title>M-Techno | Add Roadmap</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/roadmap/add_roadmap'?>"><i class="fa fa-thumb-tack"></i> Add Roadmap</a></li>
            <li><a href="<?php echo base_url().'admin/roadmap'?>"><i class="fa fa-list"></i> Roadmap List</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Roadmap</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'admin/roadmap/update_roadmap'?>" method="post" enctype="multipart/form-data">
