    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/roadmap/add_roadmap'?>"><i class="fa fa-thumb-tack"></i> Add Roadmap</a></li>
            <li class="active"><a href="<?php echo base_url().'admin/roadmap'?>"><i class="fa fa-list"></i> Roadmap List</a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/roadmap/add_roadmap'?>"><span class="fa fa-plus"></span> Add Roadmap</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/roadmap/get_edit/'.$port_id;?>"><span class="fa fa-pencil"></span></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Roadmap</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/roadmap/hapus_roadmap'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $port_id;?>"/> 
                     <input type="hidden" value="<?php echo $port_gambar;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Roadmap <b><?php echo $port_judul;?></b> ?</p>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Roadmap Berhasil disimpan ke database.",
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Roadmap berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
