...
<html class="no-js">
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/slidea_3.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Our Gallery</h2>
		   					<p class="fh5co-lead"> Awesome source code by <a href="http://kanalnuklir.id//" target="_blank">Kanal Nuklir ID</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		...
		<div class="container">
			<div class="row">
				...
				<?php	foreach ($data->result() as $row) :	?>
					<div class="col-md-4">
						<p><a class="example-image-link" href="<?php echo base_url().'assets/images/'.$row->galeri_gambar;?>" data-lightbox="example-2" data-title="<?php echo $row->galeri_judul;?>"><img class="example-image img-responsive" src="<?php echo base_url().'assets/images/'.$row->galeri_gambar;?>" alt="image-1"/></a></p>
					</div>
				<?php endforeach;?>
